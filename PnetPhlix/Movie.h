...
class Movie
{
  public:
    ...
    Movie(const std::string& id, const std::string& title,
      ...
      */
      // Had to add the vectors into params for some reason
    Movie(const std::string& id, const std::string& title,
        const std::string& release_year, const std::vector<std::string>& directors,
        const std::vector<std::string>& actors, const std::vector<std::string> genres, float rating);
